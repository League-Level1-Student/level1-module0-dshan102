...
public class BodyPartQuiz {
	...
	private void startQuiz() {
		...
		// -- Tell them they are wrong and who the person is
			...
			JOptionPane.showMessageDialog(null, "You are wrong. It is Arnold Schwarzenegger.");
		}
		...
		if(guess.equalsIgnoreCase("Leonardo DiCaprio")) {
			...
			JOptionPane.showMessageDialog(null, "You are incorrect. It is Leonardo DiCaprio.");
		}
		JOptionPane.showMessageDialog(null, "Your score is "+score);
		showNextImage();
		guess = JOptionPane.showInputDialog("Who is this?");
